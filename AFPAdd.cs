...
{
    public partial class AFPAdd : Form
    {
        public AFPAdd()
        {
            InitializeComponent();
        ...
        private void AFPAdd_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void AFPAdd_Load(object sender, EventArgs e)
        {
            try
            {
                Tid = "";
                DataManagement.DT = DataManagement.Search("select Tid from properties where left(Tid,1)='P'");
                Tid = "P" + (DataManagement.DT.Rows.Count + 1).ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        DataManagement.DT = DataManagement.I_U_D("select * from Users", "Insert Into Users(Id,Aname,Password) Values(" + textBox1.Text.ToString() + ",'" + textBox4.Text.ToString() + "','" + textBox5.Text.ToString() + "')");
                        DataManagement.DT = DataManagement.I_U_D("select * from Properties", "Insert Into Properties(Id,Tid,Name,Family,Job,Tell_1,Tell_2,Mobile_1,Mobile_2,Address_1,Address_2,Picture,Dis) Values(" + textBox1.Text.ToString() + ",'" + Tid + "','" + textBox2.Text.ToString() + "','" + textBox3.Text.ToString() + "','" + textBox6.Text.ToString() + "','" + textBox7.Text.ToString() + "','" + textBox8.Text.ToString() + "','" + textBox9.Text.ToString() + "','" + textBox10.Text.ToString() + "','" + textBox11.Text.ToString() + "','" + textBox12.Text.ToString() + "','" + PictureLocation + "','" + textBox14.Text.ToString() + "')");
                        MessageBox.Show(".مشخصات پیمانکار جدید ثبت شد", " ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        this.Close();
                    }
                    catch { }
                }
