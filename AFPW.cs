...
{
    public partial class AFPW : Form
    {
        public AFPW()
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("کارگر مورد نظر دارای گردش مالی می باشد شما قادر به حذف آن نیستید", "", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                }
                else
                {
        ...
        private void AFPW_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void AFPW_Load(object sender, EventArgs e)
        {
            try
            {
