...
{
    public partial class AFWAdd : Form
    {
        public AFWAdd()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        DataManagement.DT = DataManagement.I_U_D("select * from Properties", "Insert Into Properties(Id,Tid,Name,Family,Job,Tell_1,Tell_2,Mobile_1,Mobile_2,Address_1,Address_2,Picture,Dis) Values(" + textBox1.Text.ToString() + ",'" + Tid + "','" + textBox2.Text.ToString() + "','" + textBox3.Text.ToString() + "','" + textBox6.Text.ToString() + "','" + textBox7.Text.ToString() + "','" + textBox8.Text.ToString() + "','" + textBox9.Text.ToString() + "','" + textBox10.Text.ToString() + "','" + textBox11.Text.ToString() + "','" + textBox12.Text.ToString() + "','" + PictureLocation.ToString() + "','" + textBox14.Text.ToString() + "')");
                        MessageBox.Show(".ثبت مشخصات کارگر جدید با موفقیت انجام شد", " ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        this.Close();
                    }
                    catch { }
                }
        ...
        private void AFWAdd_Load(object sender, EventArgs e)
        {
            try
            {
                Tid = "";
                DataManagement.DT = DataManagement.Search("select Tid from properties where left(Tid,1)='W'");
                Tid = "W" + (DataManagement.DT.Rows.Count + 1).ToString();
        ...
        private void AFWAdd_KeyDown(object sender, KeyEventArgs e)
        {
