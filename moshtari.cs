    ...
    public partial class moshtari : Form
    {
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        MessageBox.Show(".مشخصات مشتری جدید ثبت شد", " ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        this.Close();
                    }
                    catch { }
                }
        ...
        private void moshtari_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Tid = "M" + (DataManagement.DT.Rows.Count + 1).ToString();
        ...
        private void moshtari_KeyDown(object sender, KeyEventArgs e)
        {
